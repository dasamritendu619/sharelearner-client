...
import { BookOpen, FileText, House, Image, MessageCircle, Plus, Search, TvMinimalPlay, UsersRound } from 'lucide-react'
      ...
      <header className='flex justify-between sm:border-b bg-gray-50 dark:bg-gray-950'>
        ...
        <div className='flex flex-nowrap justify-end  w-[50%] sm:w-[30%] md:w-[33%]'>
          ...
          {user ? <ProfileBtn className='my-2 ml-[4px] mr-1 md:mr-2 rounded-full' /> :
            <Link to='/login'
              className='my-2 ml-[4px] mr-1 md:mr-2 rounded-full bg-gray-200 text-blue-600 dark:bg-gray-700 dark:text-white font-bold py-2 px-4'>
              Login
            </Link>
          }
        </div>
