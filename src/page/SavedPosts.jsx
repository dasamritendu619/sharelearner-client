...
import { updateSavedPosts } from '@/store/postSlice'
...
export default function SavedPosts() {
  ...
  const postsData = useSelector(state => state.post.savedPosts)
  ...
  const getPosts = async (page) => {
    const limit = 15;
    const response = await savedService.getSavedPost({page,limit})
